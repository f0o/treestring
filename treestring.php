...
//  - - - - - - - - - - - - - - - -  |
// (c) by singh(at)devilcode(dot)org |
// -----------------------------------

error_reporting(0);

//settings / usage
$password   = "1wonderfullExampl3";
$identifier = "larry";

$tree=new treestring();
echo $tree->generate($password,$identifier);
echo $tree->parse($password,$identifier);
//----------------------------------------
